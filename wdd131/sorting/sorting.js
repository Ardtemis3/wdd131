...
console.log("hikes", hikes.sort(compareFnHike));

//Filter

function searchList(list, query){
    function searchCallback(item){
        return item.toLowerCase().includes(query.toLowerCase()); //includes will return either 'true', or 'flase'
    }               // add .description to item to filter
    return list.filter(searchCallback);
}

console.log("search", searchList(simpleList, "an").sort(compareFn));